...
import { I as keymap, U as placeholder, X as showTooltip, a as Decoration, at as EditorSelection, bt as countColumn, dt as RangeSetBuilder, it as Compartment, lt as Prec, mt as StateField, ot as EditorState, p as WidgetType, pt as StateEffect, s as EditorView, y as drawSelection } from "./dist-CZUc4tnw.js";
import { H as indentUnit, L as indentNodeProp, O as foldNodeProp, W as languageDataProp, Y as syntaxTree, a as Language, c as ParseContext, ct as NodeType, dt as Tree, ft as parseMixed, k as foldService, l as StreamLanguage, n as HighlightStyle, nt as styleTags, o as LanguageDescription, ot as NodeProp, q as syntaxHighlighting, rt as tags, s as LanguageSupport, st as NodeSet, tt as Tag, ut as Parser, v as defineLanguageFacet } from "./dist-DPvGmPGM.js";
import { defaultKeymap, deleteLine, history, historyKeymap, indentWithTab, redo, undo } from "./@codemirror_commands.js";
import { n as html, r as htmlCompletionSource } from "./dist-C_tNWwnF.js";
import { n as autocompletion, t as CompletionContext } from "./dist-8c8gOCml.js";
import { $n as toRef, Gn as reactive, H as cloneVNode, It as onMounted, L as Teleport, Mt as onBeforeUnmount, N as Fragment, St as inject, Tt as isVNode, W as computed, Wt as provide, Xn as shallowRef, _n as watch, kt as nextTick, ln as useId, mt as h$3, o as createApp, qn as ref, rt as defineComponent, tt as createVNode } from "./vue.runtime.esm-bundler-KfmyCvcZ.js";
import { n as searchKeymap } from "./dist-CFMCT5dE.js";
...
var M$2 = (e) => {
...
}, W$1 = () => `${Date.now().toString(36)}${Math.random().toString(36).substring(2)}`, f$1 = (e) => e !== null && typeof e == "object" && !Array.isArray(e), _$1 = /* @__PURE__ */ new Set([
	"__proto__",
	"constructor",
	"prototype"
]), C$1 = (e) => !_$1.has(e), v$1 = (e, n, t = {}) => {
	if (Array.isArray(e) && Array.isArray(n)) return y$1(e, n, t);
	const { excludeKeys: r } = t, o = e, c = n;
	for (const s of Object.keys(c)) {
		if (!C$1(s)) continue;
		const i = c[s], l = o[s];
		r && r(s) ? o[s] = i : Array.isArray(i) && Array.isArray(l) ? o[s] = y$1(l, i, t) : f$1(i) && f$1(l) ? o[s] = v$1(l, i, t) : o[s] = i;
	}
	return e;
}, y$1 = (e, n, t) => {
	const r = e.slice();
	return n.forEach((o, c) => {
		const s = r[c];
		Array.isArray(o) && Array.isArray(s) ? r[c] = y$1(s, o, t) : f$1(o) && f$1(s) ? r[c] = v$1(s, o, t) : r[c] = o;
	}), r;
};
//#endregion
...
var O$1 = {
	...
	setup(e, a) {
		...
		return onMounted(() => {
			o.value.addEventListener("mouseenter", u$32), o.value.addEventListener("mouseleave", v), l.value.addEventListener("mouseenter", b), l.value.addEventListener("mouseleave", v);
		}), onBeforeUnmount(() => {
			o.value.removeEventListener("mouseenter", u$32), o.value.removeEventListener("mouseleave", v), l.value.removeEventListener("mouseenter", b), l.value.removeEventListener("mouseleave", v);
		}), () => {
...
var i$1 = "onSave", C = "changeCatalogVisible", h$1 = "changeFullscreen", _ = "pageFullscreenChanged", r$1 = "fullscreenChanged", A$1 = "previewChanged", R$1 = "previewOnlyChanged", p$1 = "htmlPreviewChanged", g$1 = "catalogVisibleChanged", L = "buildFinished", N$1 = "errorCatcher", G$1 = "replace", I = "uploadImage", T = "ctrlZ", d = "ctrlShiftZ", S$1 = "catalogChanged", H = "pushCatalog", D$1 = "rerender", V$1 = "eventListener", O = "taskStateChanged", u$2 = "sendEditorView", f = "getEditorView";
var c = class {
	pools = {};
	remove(s, o, a) {
...
var ce$1 = `.${u}-preview > [data-line]`, w$1 = (e, l) => +getComputedStyle(e).getPropertyValue(l).replace("px", ""), ve$2 = (e, l) => {
	...
	const { view: n } = p, E = R$2(), m = (c) => n.lineBlockAt(n.state.doc.line(c + 1).from).top, y = (c) => n.lineBlockAt(n.state.doc.line(c + 1).from).bottom;
	let f = [], s = [], r = [];
	const L = () => {
...
var j$2 = {
...
}, p = (d, s) => typeof s[d] == "string" ? s[d] : j$2[d], z$1 = (d, s) => {
	const e = (c) => {
	...
	return (e, c) => {
		...
		return e?.forEach((n) => {
			...
			const l = r.querySelector(`.${u}-mermaid-zoom`), u$31 = () => {
				const a = t.get(n);
			...
			l.addEventListener("click", u$31), t.set(n, { removeClick: () => l.removeEventListener("click", u$31) });
		}), () => {
...
*/
var fromCodePoint$1 = (_a$1 = String.fromCodePoint) !== null && _a$1 !== void 0 ? _a$1 : function(codePoint) {
	let output = "";
	if (codePoint > 65535) {
		codePoint -= 65536;
...
var M$1 = {
	...
	const o = h$2.editorExtensions.highlight, m = h$2.editorExtensionsAttrs.highlight;
	provide("editorId", t), provide("rootRef", r), provide("theme", computed(() => e.theme)), provide("language", computed(() => e.language)), provide("highlight", computed(() => {
		const { js: u } = o, s = {
			...g$3,
			...o.css
		}, { js: l, css: i = {} } = m || {}, a = e.codeStyleReverse && e.codeStyleReverseList.includes(e.previewTheme) ? "dark" : e.theme, c = s[e.codeTheme] ? s[e.codeTheme][a] : g$3.atom[a], $ = s[e.codeTheme] && i[e.codeTheme] ? i[e.codeTheme][a] : i.atom ? i.atom[a] : {};
		return {
			js: {
				src: u,
				...l
	...
	return provide("usedLanguageText", computed(() => {
		...
		return v$1(u$3(v["en-US"]), u[e.language] || {});
...
}, Jt = (e, t) => (provide("tabWidth", e.tabWidth), provide("disabled", computed(() => e.disabled)), provide("showToolbarName", computed(() => e.showToolbarName)), provide("noUploadImg", e.noUploadImg), provide("tableShape", computed(() => e.tableShape)), provide("noPrettier", e.noPrettier), provide("codeTheme", computed(() => e.codeTheme)), provide("updateSetting", t.updateSetting), provide("catalogVisible", computed(() => t.catalogVisible.value)), provide("defToolbars", t.defToolbars), provide("floatingToolbars", computed(() => e.floatingToolbars)), Te(e, t)), Xt = (e) => {
	const { noPrettier: t, noUploadImg: r } = e, { editorExtensions: n, editorExtensionsAttrs: o } = h$2, m = t || n.prettier.prettierInstance, d = t || n.prettier.parserMarkdownInstance, u = r || n.cropper.instance;
	onMounted(() => {
		if (!u) {
	...
	watch(() => m.pageFullscreen, (l) => {
		F.emit(n, _, l);
	}), watch(() => m.fullscreen, (l) => {
		F.emit(n, r$1, l);
	}), watch(() => m.preview, (l) => {
		F.emit(n, A$1, l);
	}), watch(() => m.previewOnly, (l) => {
		F.emit(n, R$1, l);
	}), watch(() => m.htmlPreview, (l) => {
		F.emit(n, p$1, l);
	}), watch(o, (l) => {
		F.emit(n, g$1, l);
	});
	t.expose({
		...
		insert(l) {
			F.emit(n, G$1, "universal", { generate: l });
		},
		focus(l) {
			u.value?.focus(l);
		},
	...
	const n = inject("editorId"), o = inject("rootRef"), m = inject("usedLanguageText"), d = inject("setting"), u$19 = () => {
		o.value.querySelectorAll(`#${n} .${u}-preview .${u}-code`).forEach((i) => {
			let a = -1;
			const c = i.querySelector(`.${u}-copy-button:not([data-processed])`);
			c && (c.onclick = ($) => {
				...
				let b = T;
				copy2Clipboard(e.formatCopiedText(g || "")).catch(() => {
					b = y;
				}).finally(() => {
	...
	watch([t, r], s), watch(() => d.value.preview, l), watch(() => d.value.htmlPreview, l), onMounted(u$19);
}, nt = (e) => {
	const t = inject("editorId"), r = inject("theme"), n = inject("rootRef"), { editorExtensions: o, editorExtensionsAttrs: m, echartsConfig: d } = h$2;
	let u$20 = o.echarts.instance;
	const s = shallowRef(-1), l = () => {
		!e.noEcharts && u$20 && (s.value = s.value + 1);
	};
	watch(() => r.value, () => {
		l();
	}), onMounted(() => {
		if (e.noEcharts || u$20) return;
	...
	const $ = (g = !1) => {
		...
		$(), !e.noEcharts && u$20 && Array.from(n.value.querySelectorAll(`#${t} div.md-editor-echarts:not([data-processed])`)).forEach((h) => {
			if (h.dataset.closed === "false") return !1;
			try {
				const y = d(o.echarts.parseOption(h.innerText, {
					editorId: t,
					element: h
				})), b = u$20.init(h, r.value);
...
var rt = class {
	...
	trim() {
		for (const [t, r] of this.cache) if (!this.deleteExpired(t, r)) break;
	...
	get(t) {
		...
		if (!(!r || this.deleteExpired(t, r))) return this.cache.delete(t), this.cache.set(t, r), r.value;
	}
	set(t, r) {
...
var Y$1 = new rt({
	...
	const t = inject("editorId"), r = inject("theme"), n = inject("rootRef"), { editorExtensions: o, editorExtensionsAttrs: m, mermaidConfig: d } = h$2;
	let u$21 = o.mermaid.instance;
	const s = shallowRef(-1), l = () => {
		if (!e.noMermaid && u$21) {
			...
			u$21.initialize(d(a)), s.value = s.value + 1;
		}
	};
	return watch(() => r.value, () => {
		Y$1.clear(), l();
	}), onMounted(() => {
		if (e.noMermaid || u$21) return;
		...
		replaceMermaid: async () => {
			if (!e.noMermaid && u$21) {
				const a = n.value.querySelectorAll(`div.${u}-mermaid`), c = document.createElement("div"), $ = document.body.offsetWidth > 1366 ? document.body.offsetWidth : 1366, p = document.body.offsetHeight > 768 ? document.body.offsetHeight : 768;
				c.style.width = $ + "px", c.style.height = p + "px", c.style.position = "fixed", c.style.zIndex = "-10000", c.style.top = "-10000";
				let g = a.length;
				g > 0 && document.body.appendChild(c), await Promise.allSettled(Array.from(a).map((h) => (async (y) => {
					if (y.dataset.closed === "false") return !1;
					const b = y.innerText;
					let S = Y$1.get(b);
					if (!S) {
						const w = W$1();
						let F$4 = { svg: "" };
						try {
							F$4 = await u$21.render(w, b, c), S = await e.sanitizeMermaid(F$4.svg);
							const x = document.createElement("p");
							x.className = `${u}-mermaid`, x.setAttribute("data-processed", ""), x.setAttribute("data-content", b), x.innerHTML = S, x.children[0]?.removeAttribute("height"), Y$1.set(b, x.innerHTML), y.dataset.line !== void 0 && (x.dataset.line = y.dataset.line), y.replaceWith(x);
						} catch (x) {
							F.emit(t, N$1, {
								name: "mermaid",
								message: x.message,
	...
	const s = (i, a, c, $, p) => {
		const g = i[a];
		return g.type === "admonition_open" ? i[a].attrPush(["class", `${u}-admonition ${u}-admonition-${g.info}`]) : g.type === "admonition_title_open" && i[a].attrPush(["class", `md-editor-admonition-title`]), p.renderToken(i, a, c);
	}, l = (i) => {
		const a = i.trim().split(" ", 2);
		u$22 = "", d = a[0], a.length > 1 && (u$22 = i.substring(d.length + 2));
	};
	e.block.ruler.before("code", "admonition", (i, a, c, $) => {
		let p, g, h, T = !1, y = i.bMarks[a] + i.tShift[a], b = i.eMarks[a];
		if (o !== i.src.charCodeAt(y)) return !1;
		for (p = y + 1; p <= b && n[(p - y) % m] === i.src[p]; p++);
		const S = Math.floor((p - y) / m);
		if (S !== r) return !1;
		p -= (p - y) % m;
		const w = i.src.slice(y, p);
		if (l(i.src.slice(p, b)), $) return !0;
		for (g = a; g++, !(g >= c || (y = i.bMarks[g] + i.tShift[g], b = i.eMarks[g], y < b && i.sCount[g] < i.blkIndent));) if (o === i.src.charCodeAt(y) && !(i.sCount[g] - i.blkIndent >= 4)) {
			for (p = y + 1; p <= b && n[(p - y) % m] === i.src[p]; p++);
	...
	const r = e.renderer.rules.fence, n = e.utils.unescapeAll, o = /\[(\w*)(?::([\w ]*))?\]/, m = /::(open|close)/, d = (a) => a.info ? n(a.info).trim() : "", u$23 = (a) => {
		...
		const c = a.info.match(m) || [];
		return {
			open: c[1] === "open" || c[1] !== "close" && t.codeFoldable && a.content.trim().split(`
`).length < t.autoFoldThreshold,
			tagContainer: c[1] || t.codeFoldable ? "details" : "div",
			tagHeader: c[1] || t.codeFoldable ? "summary" : "div"
		};
	}, i = (a, c, $, p$3, g) => {
		if (a[c].hidden) return "";
		const h = t.usedLanguageTextRef.value?.copyCode.text, T = t.customIconRef.value.copy || h, y = !!t.customIconRef.value.copy, b = `<span class="${u}-collapse-tips">${p("collapse-tips", t.customIconRef.value)}</span>`, [S] = u$23(a[c]);
		if (S === null) {
			const { open: k, tagContainer: R, tagHeader: J } = l(a[c]), B = [["class", `${u}-code`]];
			k && B.push(["open", ""]);
			const ne = { attrs: se$2(a[c], B) };
        ...
        <${R} ${g.renderAttrs(ne)}>
          <${J} class="${u}-code-head">
            ...
            <div class="${u}-code-action">
              <span class="${u}-code-lang">${e.utils.escapeHtml(a[c].info.trim())}</span>
              <span class="${u}-copy-button" data-tips="${h}"${y ? " data-is-icon=true" : ""}>${T}</span>
      ...
      `;
		...
		let w, F, x, L, _ = "", N = "", D = "";
		const { open: q, tagContainer: V, tagHeader: z } = l(a[c]), K = [["class", `${u}-code`]];
		q && K.push(["open", ""]);
		const Z = { attrs: se$2(a[c], K) };
		for (let k = c; k < a.length && (w = a[k], [F, x] = u$23(w), F === S); k++) {
			w.info = w.info.replace(o, "").replace(m, ""), w.hidden = !0;
			const R = `${u}-codetab-${t.editorId}-${c}-${k - c}`;
			L = k - c > 0 ? "" : "checked", _ += `
        <li>
          <input
            type="radio"
            id="label-${u}-codetab-label-1-${t.editorId}-${c}-${k - c}"
            name="${u}-codetab-label-${t.editorId}-${c}"
            class="${R}"
            ${L}
          >
          <label
            for="label-${u}-codetab-label-1-${t.editorId}-${c}-${k - c}"
        ...
        <div role="tabpanel">
          <input
            type="radio"
            name="${u}-codetab-pre-${t.editorId}-${c}"
            class="${R}"
            ${L}
            role="presentation">
          ${r(a, k, $, p$3, g)}
        ...
        <input
          type="radio"
          name="${u}-codetab-lang-${t.editorId}-${c}"
          class="${R}"
          ${L}
          role="presentation">
        <span class=${u}-code-lang role="note">${e.utils.escapeHtml(s(w))}</span>`;
		}
		return `
      <${V} ${g.renderAttrs(Z)}>
        <${z} class="${u}-code-head">
	...
	e.renderer.rules.fence = (n, o, m, d, u$24) => {
		...
		if (s.info === "echarts") {
			...
			return `<div ${u$24.renderAttrs(s)} style="width: 100%; aspect-ratio: 4 / 3;">${e.utils.escapeHtml(l)}</div>`;
		}
		return r(n, o, m, d, u$24);
	};
}, dt = (e, t) => {
	e.renderer.rules.heading_open = (r, n) => {
		const o = r[n], m = r[n + 1].children?.reduce((u, s) => u + ([
			"text",
			"code_inline",
			"math_inline"
		].includes(s.type) && s.content || ""), "") || "", d = o.markup.length;
	...
	for (const o of n) {
		...
		if (d !== -1) {
			if (d - m === 0) return r || (t.pending += o.open + o.close), t.pos = d + o.close.length, !0;
			if (!r) {
	...
	for (const l of m) {
		...
		if (!$ && !p && !g) continue;
		if (o) return !0;
		if (p) return s("", r + 1, l.open);
		if (!$ && g) return s(c.slice(0, -l.close.length), r + 1, l.open);
		let h = r + 1, T = !1, y = "";
		for (; h < n; h++) {
			const w = t.bMarks[h] + t.tShift[h], F = t.eMarks[h];
			if (w < F && t.tShift[h] < t.blkIndent) break;
		...
		if (!T) continue;
		return s(t.getLines(r + 1, h, t.tShift[r], !0) + (y.trim() ? y : ""), h + 1, l.open);
	}
	return !1;
}, ft = (e, { katexRef: t, inlineDelimiters: r, blockDelimiters: n }) => {
	const o = (u, s, l, i, a = !1) => {
		const c = { attrs: se$2(u, [["class", s]]) }, $ = i.renderAttrs(c);
		if (!t.value) return `<${l} ${$}>${u.content}</${l}>`;
		return `<${l} ${$} data-processed>${t.value.renderToString(u.content, h$2.katexConfig({
			throwOnError: !1,
			displayMode: a
		}))}</${l}>`;
	}, m = (u$25, s, l, i, a) => o(u$25[s], `${u}-katex-inline`, "span", a), d = (u$26, s, l, i, a) => o(u$26[s], `${u}-katex-block`, "p", a, !0);
	...
	const r = e.renderer.rules.fence.bind(e.renderer.rules);
	e.renderer.rules.fence = (n, o, m, d, u$27) => {
		const s = n[o], l = s.content.trim();
		if (s.info === "mermaid") {
			...
			const i = Y$1.get(l);
			return i ? (s.attrSet("data-processed", ""), s.attrSet("data-content", l), `<p ${u$27.renderAttrs(s)}>${i}</p>`) : `<div ${u$27.renderAttrs(s)}>${e.utils.escapeHtml(l)}</div>`;
		}
		return r(n, o, m, d, u$27);
	};
}, $e = (e, t, r) => {
	...
	if (e.children = e.children || [], e.children.unshift(kt(e, t, r)), e.children[1].content = e.children[1].content.slice(3), e.content = e.content.slice(3), r.label) if (r.labelAfter) {
		e.children.pop();
	...
	const { editorConfig: r$2, markdownItConfig: n, markdownItPlugins: o, editorExtensions: m } = h$2, d = inject("editorId"), u$28 = inject("language"), s = inject("usedLanguageText"), l$2 = inject("showCodeRowNumber"), i = inject("theme"), a = inject("customIcon"), c = inject("rootRef"), $ = inject("setting"), p = ref([]), g = ot(e), h = at(e), { reRenderRef: T, replaceMermaid: y } = lt(e), { reRenderEcharts: b, replaceEcharts: S } = nt(e), w = MarkdownIt({
		html: !0,
		breaks: !0,
		linkify: !0
	});
	...
	w.set({ highlight: (k, R, J) => {
		...
		return `<pre><code class="language-${R}" language=${R}>${l$2 ? l(B.replace(/^\n+|\n+$/g, ""), k.replace(/^\n+|\n+$/g, "")) : `<span class="${u}-code-block">${B.replace(/^\n+|\n+$/g, "")}</span>`}</code></pre>`;
	} }), It(w);
	const L$2 = ref(`_article-key_${W$1()}`), _ = ref(e.sanitize(w.render(e.modelValue, { srcLines: e.modelValue.split(`
`) })));
	let N = () => {}, D = () => {};
	const q = () => {
		const k = c.value?.querySelectorAll(`#${d} p.${u}-mermaid:not([data-closed=false])`);
		D(), D = V(k, { customIcon: a.value }), m.mermaid?.enableZoom && (N(), N = R(k, { customIcon: a.value }));
	}, V$3 = () => {
		F.emit(d, L, _.value), e.onHtmlChanged(_.value), e.onGetCatalog(p.value), F.emit(d, S$1, p.value), nextTick(() => {
			y().then(q), S();
		});
	}, z = () => {
		p.value = [], _.value = e.sanitize(w.render(e.modelValue, { srcLines: e.modelValue.split(`
`) }));
	}, K = computed(() => (e.noKatex || !!h.value) && (e.noHighlight || !!g.value));
	let Z = -1;
	return watch([
		toRef(e, "modelValue"),
		K,
		...
		$.value.preview && nextTick(() => {
			y().then(q), S(), F.emit(d, "catalogChanged", p.value);
		});
	}), watch([_, b], () => {
		V$3();
		...
		F.on(d, {
			name: H,
			callback() {
				F.emit(d, S$1, p.value);
			}
		}), F.on(d, {
			name: D$1,
			callback: () => {
				L$2.value = `_article-key_${W$1()}`, z();
			}
		});
	}), onBeforeUnmount(() => {
		N(), D(), clearTimeout(Z);
	...
	const r = inject("editorId"), n = inject("setting"), { noImgZoomIn: o } = e, m = x(() => {
		const d = document.querySelectorAll(`#${r}-preview img:not(.not-zoom):not(.medium-zoom-image)`);
		d.length !== 0 && mediumZoom(d, { background: "#00000073" });
	});
	onMounted(async () => {
...
`), $ = c[Number(a)].replace(we[l].regexp, we[l].value);
...
`))) : F.emit(r, O, a + 1, $);
	...
	watch([t, r], o), watch(() => n.value.preview, m), watch(() => n.value.htmlPreview, m), onMounted(o);
}, xe$2 = {
	modelValue: {
		type: String,
		default: ""
	...
	*/
	...
	setup(e) {
		const t = ref(), r = e.html, n = (o, m) => {
			if (!t.value) return;
			const d = t.value, u = Array.from(d.childNodes), s = Math.min(o.length, m.length);
			let l = -1;
			for (let a = 0; a < s; a++) if (!Ht(o[a], m[a])) {
				l = a;
				break;
			}
			if (l === -1) if (m.length > o.length) l = o.length;
			else if (o.length > m.length) l = m.length;
			else return;
			const i = Math.min(l, u.length);
			for (let a = u.length - 1; a >= i; a--) u[a].remove();
			for (let a = l; a < o.length; a++) d.appendChild(o[a].cloneNode(!0));
		};
		return watch(() => e.html, (o, m) => {
			n(Ce$1(o), Ce$1(m || ""));
		}), () => createVNode("div", {
			id: e.id,
			class: e.class,
	...
	props: xe$2,
	setup(e) {
		const t = inject("editorId"), r = inject("setting"), n = inject("previewTheme"), o = inject("showCodeRowNumber"), { html: m, key: d } = St(e, e.previewOnly);
		...
		}, [createVNode("div", { class: `md-editor-html` }, [m.value])])]);
	}
}), Lt = ({ text: e }) => e, Ie$1 = {
	/**
	* markdown content.
	...
	*/
	...
	emits: Se$1,
	setup(e, t) {
		const { noKatex: r, noMermaid: n, noHighlight: o } = e, m = ref(), d = et(e);
		Te(e, {
			rootRef: m,
			editorId: d
		}), Ot(e, t, { editorId: d }), onBeforeUnmount(() => {
			F.clear(d);
		});
		const u$30 = (a) => {
...
* See the LICENSE file in the root directory of this source tree.
*/
var Strikethrough$1 = createLucideIcon("strikethrough", [
	["path", {
...
* See the LICENSE file in the root directory of this source tree.
*/
var Subscript$1 = createLucideIcon("subscript", [
	["path", {
		d: "m4 5 8 8",
		key: "1eunvl"
	}],
...
* See the LICENSE file in the root directory of this source tree.
*/
var Superscript$1 = createLucideIcon("superscript", [
	["path", {
		d: "m4 19 8-8",
		key: "hr47gm"
	}],
	...
	setup(e, u$18) {
		...
		watch(() => e.isFullscreen, (o) => {
			...
			o ? (n.maskStyle.zIndex = h$2.editorConfig.zIndex + m$1(), n.modalStyle.zIndex = h$2.editorConfig.zIndex + m$1(), r.value.push("zoom-in"), m.value = o, nextTick(() => {
				...
				n.initPos.insetInlineStart = T - i + "px", n.initPos.insetBlockStart = H - s + "px", e.isFullscreen || (d = z$1(h.value, (A, L) => {
...
function sql(dialectName) {
	return import("./dist-C4ocHatx.js").then((m) => m.sql({ dialect: m[dialectName] }));
}
/**
...
var languages = [
	/*@__PURE__*/ LanguageDescription.of({
		...
		load() {
			return import("./dist-DKvBxTiz.js").then((m) => m.cpp());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "C++",
	...
	/*@__PURE__*/ LanguageDescription.of({
		...
		extensions: ["css"],
		load() {
			return import("./dist-B_vKGQ01.js").then((n) => n.u).then((m) => m.css());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Go",
		extensions: ["go"],
		load() {
			return import("./dist-Bgi2GfrS.js").then((m) => m.go());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "HTML",
	...
	/*@__PURE__*/ LanguageDescription.of({
		...
		extensions: ["java"],
		load() {
			return import("./dist-DLs-kCNw.js").then((m) => m.java());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "JavaScript",
		...
		load() {
			return import("./dist-B_vKGQ01.js").then((n) => n.t).then((m) => m.javascript());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Jinja",
		...
		load() {
			return import("./dist-BBwDR6mv.js").then((m) => m.jinja());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "JSON",
		...
		extensions: ["json", "map"],
		load() {
			return import("./dist-BWJz62Hh.js").then((m) => m.json());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "JSX",
		extensions: ["jsx"],
		load() {
			return import("./dist-B_vKGQ01.js").then((n) => n.t).then((m) => m.javascript({ jsx: true }));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "LESS",
		extensions: ["less"],
		load() {
			return import("./dist-vc7b4_87.js").then((m) => m.less());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Liquid",
		extensions: ["liquid"],
		load() {
			return import("./dist-DnHqx9W_.js").then((m) => m.liquid());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "MariaDB SQL",
	...
	/*@__PURE__*/ LanguageDescription.of({
		...
		load() {
			return Promise.resolve().then(() => dist_exports).then((m) => m.markdown());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "MS SQL",
	...
	/*@__PURE__*/ LanguageDescription.of({
		...
		load() {
			return import("./dist-B9i7MaIv.js").then((m) => m.php());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "PLSQL",
	...
	/*@__PURE__*/ LanguageDescription.of({
		...
		filename: /^(BUCK|BUILD)$/,
		load() {
			return import("./dist-B743h5SK.js").then((m) => m.python());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Rust",
		extensions: ["rs"],
		load() {
			return import("./dist-Br-GHAlO.js").then((m) => m.rust());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Sass",
		extensions: ["sass"],
		load() {
			return import("./dist-COlm1CFt.js").then((m) => m.sass({ indented: true }));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "SCSS",
		extensions: ["scss"],
		load() {
			return import("./dist-COlm1CFt.js").then((m) => m.sass());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "SQL",
	...
	/*@__PURE__*/ LanguageDescription.of({
		...
		load() {
			return import("./dist-B_vKGQ01.js").then((n) => n.t).then((m) => m.javascript({ typescript: true }));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "WebAssembly",
		extensions: ["wat", "wast"],
		load() {
			return import("./dist-DQFfyuMg.js").then((m) => m.wast());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "XML",
		...
		load() {
			return import("./dist-IpcK2j5r.js").then((m) => m.xml());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "YAML",
		...
		extensions: ["yaml", "yml"],
		load() {
			return import("./dist-CiEtRd1D.js").then((m) => m.yaml());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "APL",
		...
		load() {
			return import("./apl-3JbH1QFw.js").then((m) => legacy(m.apl));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "PGP",
		...
		load() {
			return import("./asciiarmor-5811qIho.js").then((m) => legacy(m.asciiArmor));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "ASN.1",
		extensions: ["asn", "asn1"],
		load() {
			return import("./asn1-CmMlHCrA.js").then((m) => legacy(m.asn1({})));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Asterisk",
		...
		load() {
			return import("./asterisk-DiFsF1gc.js").then((m) => legacy(m.asterisk));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Brainfuck",
		extensions: ["b", "bf"],
		load() {
			return import("./brainfuck-uPmJfZWY.js").then((m) => legacy(m.brainfuck));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Cobol",
		extensions: ["cob", "cpy"],
		load() {
			return import("./cobol-BmeAAw4o.js").then((m) => legacy(m.cobol));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "C#",
		...
		extensions: ["cs"],
		load() {
			return import("./clike-HffhpLGr.js").then((m) => legacy(m.csharp));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Clojure",
		...
		load() {
			return import("./clojure-C1wjBQjb.js").then((m) => legacy(m.clojure));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "ClojureScript",
	...
	/*@__PURE__*/ LanguageDescription.of({
		...
		extensions: ["gss"],
		load() {
			return import("./css-DpQiSk4W.js").then((m) => legacy(m.gss));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "CMake",
		...
		load() {
			return import("./cmake-DFbHdH-1.js").then((m) => legacy(m.cmake));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "CoffeeScript",
		...
		extensions: ["coffee"],
		load() {
			return import("./coffeescript-ZpEtm5-0.js").then((m) => legacy(m.coffeeScript));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Common Lisp",
		...
		load() {
			return import("./commonlisp-CfAVwQ1l.js").then((m) => legacy(m.commonLisp));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Cypher",
		...
		load() {
			return import("./cypher-CblJrMBc.js").then((m) => legacy(m.cypher));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Cython",
		...
		load() {
			return import("./python-C2NtN_-O.js").then((m) => legacy(m.cython));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Crystal",
		extensions: ["cr"],
		load() {
			return import("./crystal-DHjYP0rj.js").then((m) => legacy(m.crystal));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "D",
		extensions: ["d"],
		load() {
			return import("./d-Doaxrz2r.js").then((m) => legacy(m.d));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Dart",
		extensions: ["dart"],
		load() {
			return import("./clike-HffhpLGr.js").then((m) => legacy(m.dart));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "diff",
		...
		load() {
			return import("./diff-ei2LzbNV.js").then((m) => legacy(m.diff));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Dockerfile",
		filename: /^Dockerfile$/,
		load() {
			return import("./dockerfile-qRQwwj-y.js").then((m) => legacy(m.dockerFile));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "DTD",
		extensions: ["dtd"],
		load() {
			return import("./dtd-CbNqZR6-.js").then((m) => legacy(m.dtd));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Dylan",
		...
		load() {
			return import("./dylan-CETXHwdZ.js").then((m) => legacy(m.dylan));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "EBNF",
		load() {
			return import("./ebnf-CyPZmPnq.js").then((m) => legacy(m.ebnf));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "ECL",
		extensions: ["ecl"],
		load() {
			return import("./ecl-hMyS5s6r.js").then((m) => legacy(m.ecl));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "edn",
	...
	/*@__PURE__*/ LanguageDescription.of({
		...
		extensions: ["e"],
		load() {
			return import("./eiffel-B9pxPixJ.js").then((m) => legacy(m.eiffel));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Elm",
		extensions: ["elm"],
		load() {
			return import("./elm-DE2kDZmp.js").then((m) => legacy(m.elm));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Erlang",
		extensions: ["erl"],
		load() {
			return import("./erlang-fBSPPH-1.js").then((m) => legacy(m.erlang));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Esper",
		load() {
			return import("./sql-D9nEMNhz.js").then((m) => legacy(m.esper));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Factor",
		extensions: ["factor"],
		load() {
			return import("./factor-BKz8VQZ5.js").then((m) => legacy(m.factor));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "FCL",
		load() {
			return import("./fcl-U9HGYJzK.js").then((m) => legacy(m.fcl));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Forth",
		...
		load() {
			return import("./forth-CAn4w24i.js").then((m) => legacy(m.forth));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Fortran",
		...
		load() {
			return import("./fortran-BOtmusLb.js").then((m) => legacy(m.fortran));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "F#",
		...
		extensions: ["fs"],
		load() {
			return import("./mllike-CmByegCz.js").then((m) => legacy(m.fSharp));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Gas",
		extensions: ["s"],
		load() {
			return import("./gas-J1t9Zg0-.js").then((m) => legacy(m.gas));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Gherkin",
		extensions: ["feature"],
		load() {
			return import("./gherkin-jWe1TUS7.js").then((m) => legacy(m.gherkin));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Groovy",
		...
		load() {
			return import("./groovy-X2p2fNOA.js").then((m) => legacy(m.groovy));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Haskell",
		extensions: ["hs"],
		load() {
			return import("./haskell-CuQ2KxRY.js").then((m) => legacy(m.haskell));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Haxe",
		extensions: ["hx"],
		load() {
			return import("./haxe-f1w6O5R4.js").then((m) => legacy(m.haxe));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "HXML",
		extensions: ["hxml"],
		load() {
			return import("./haxe-f1w6O5R4.js").then((m) => legacy(m.hxml));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "HTTP",
		load() {
			return import("./http-Dnp3fqZ-.js").then((m) => legacy(m.http));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "IDL",
		extensions: ["pro"],
		load() {
			return import("./idl-CdIKZnKf.js").then((m) => legacy(m.idl));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "JSON-LD",
		...
		extensions: ["jsonld"],
		load() {
			return import("./javascript-CTOC6xAa.js").then((m) => legacy(m.jsonld));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Julia",
		extensions: ["jl"],
		load() {
			return import("./julia-DZM201TO.js").then((m) => legacy(m.julia));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Kotlin",
		extensions: ["kt", "kts"],
		load() {
			return import("./clike-HffhpLGr.js").then((m) => legacy(m.kotlin));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "LiveScript",
		...
		extensions: ["ls"],
		load() {
			return import("./livescript-BHzZKcHp.js").then((m) => legacy(m.liveScript));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Lua",
		extensions: ["lua"],
		load() {
			return import("./lua-CCSUdSHz.js").then((m) => legacy(m.lua));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "mIRC",
		extensions: ["mrc"],
		load() {
			return import("./mirc-0u3GVQND.js").then((m) => legacy(m.mirc));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Mathematica",
		...
		load() {
			return import("./mathematica-BO4dqqp2.js").then((m) => legacy(m.mathematica));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Modelica",
		extensions: ["mo"],
		load() {
			return import("./modelica-Cm0D7UOA.js").then((m) => legacy(m.modelica));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "MUMPS",
		extensions: ["mps"],
		load() {
			return import("./mumps-B24WE0Or.js").then((m) => legacy(m.mumps));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Mbox",
		extensions: ["mbox"],
		load() {
			return import("./mbox-C1De1rCN.js").then((m) => legacy(m.mbox));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Nginx",
		...
		load() {
			return import("./nginx-HOT8oB_T.js").then((m) => legacy(m.nginx));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "NSIS",
		extensions: ["nsh", "nsi"],
		load() {
			return import("./nsis-hTpeuJfM.js").then((m) => legacy(m.nsis));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "NTriples",
		extensions: ["nt", "nq"],
		load() {
			return import("./ntriples-BtZY9Tg2.js").then((m) => legacy(m.ntriples));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Objective-C",
		...
		extensions: ["m"],
		load() {
			return import("./clike-HffhpLGr.js").then((m) => legacy(m.objectiveC));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Objective-C++",
		...
		extensions: ["mm"],
		load() {
			return import("./clike-HffhpLGr.js").then((m) => legacy(m.objectiveCpp));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "OCaml",
		...
		load() {
			return import("./mllike-CmByegCz.js").then((m) => legacy(m.oCaml));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Octave",
		extensions: ["m"],
		load() {
			return import("./octave-D-Mf_lP5.js").then((m) => legacy(m.octave));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Oz",
		extensions: ["oz"],
		load() {
			return import("./oz-BzzQuVjw.js").then((m) => legacy(m.oz));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Pascal",
		extensions: ["p", "pas"],
		load() {
			return import("./pascal-ftTHxfIF.js").then((m) => legacy(m.pascal));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Perl",
		extensions: ["pl", "pm"],
		load() {
			return import("./perl-BshR5GQ9.js").then((m) => legacy(m.perl));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Pig",
		extensions: ["pig"],
		load() {
			return import("./pig-DY86aQAv.js").then((m) => legacy(m.pig));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "PowerShell",
		...
		load() {
			return import("./powershell-BYm6PeTI.js").then((m) => legacy(m.powerShell));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		...
		load() {
			return import("./properties-DeMCJLEf.js").then((m) => legacy(m.properties));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "ProtoBuf",
		extensions: ["proto"],
		load() {
			return import("./protobuf-B1tneDx6.js").then((m) => legacy(m.protobuf));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Pug",
		...
		extensions: ["pug", "jade"],
		load() {
			return import("./pug-BYC97_YH.js").then((m) => legacy(m.pug));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Puppet",
		extensions: ["pp"],
		load() {
			return import("./puppet-CgjfFbLI.js").then((m) => legacy(m.puppet));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Q",
		extensions: ["q"],
		load() {
			return import("./q-ChHOoD7z.js").then((m) => legacy(m.q));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "R",
		...
		extensions: ["r", "R"],
		load() {
			return import("./r-Cty-UPwq.js").then((m) => legacy(m.r));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "RPM Changes",
		load() {
			return import("./rpm-C7__opOD.js").then((m) => legacy(m.rpmChanges));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "RPM Spec",
		extensions: ["spec"],
		load() {
			return import("./rpm-C7__opOD.js").then((m) => legacy(m.rpmSpec));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Ruby",
		...
		load() {
			return import("./ruby-CrY6UE9N.js").then((m) => legacy(m.ruby));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "SAS",
		extensions: ["sas"],
		load() {
			return import("./sas-BQP72uW7.js").then((m) => legacy(m.sas));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Scala",
		extensions: ["scala"],
		load() {
			return import("./clike-HffhpLGr.js").then((m) => legacy(m.scala));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Scheme",
		extensions: ["scm", "ss"],
		load() {
			return import("./scheme-Clera2MT.js").then((m) => legacy(m.scheme));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Shell",
		...
		filename: /^PKGBUILD$/,
		load() {
			return import("./shell-C61GCsJA.js").then((m) => legacy(m.shell));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Sieve",
		...
		load() {
			return import("./sieve-uP63Glg0.js").then((m) => legacy(m.sieve));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Smalltalk",
		extensions: ["st"],
		load() {
			return import("./smalltalk-C9KLJwAY.js").then((m) => legacy(m.smalltalk));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Solr",
		load() {
			return import("./solr-CWIKYH15.js").then((m) => legacy(m.solr));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "SML",
		...
		load() {
			return import("./mllike-CmByegCz.js").then((m) => legacy(m.sml));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "SPARQL",
		...
		load() {
			return import("./sparql-D_IkwgoY.js").then((m) => legacy(m.sparql));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Spreadsheet",
		alias: ["excel", "formula"],
		load() {
			return import("./spreadsheet-BRJxPl_W.js").then((m) => legacy(m.spreadsheet));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Squirrel",
		extensions: ["nut"],
		load() {
			return import("./clike-HffhpLGr.js").then((m) => legacy(m.squirrel));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Stylus",
		extensions: ["styl"],
		load() {
			return import("./stylus-AOAV-sSp.js").then((m) => legacy(m.stylus));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Swift",
		extensions: ["swift"],
		load() {
			return import("./swift-Cxsy3pbG.js").then((m) => legacy(m.swift));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "sTeX",
		load() {
			return import("./stex-BUlOgYBB.js").then((m) => legacy(m.stex));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "LaTeX",
	...
	/*@__PURE__*/ LanguageDescription.of({
		...
		load() {
			return import("./verilog-DhPScf3D.js").then((m) => legacy(m.verilog));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Tcl",
		extensions: ["tcl"],
		load() {
			return import("./tcl-C6Dlqr9m.js").then((m) => legacy(m.tcl));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Textile",
		extensions: ["textile"],
		load() {
			return import("./textile-D3IvrUTT.js").then((m) => legacy(m.textile));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "TiddlyWiki",
		load() {
			return import("./tiddlywiki-BBdU_GSl.js").then((m) => legacy(m.tiddlyWiki));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Tiki wiki",
		load() {
			return import("./tiki-Bzn_mT47.js").then((m) => legacy(m.tiki));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "TOML",
		extensions: ["toml"],
		load() {
			return import("./toml-C2HBbPgG.js").then((m) => legacy(m.toml));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Troff",
		...
		load() {
			return import("./troff-DpKX83PR.js").then((m) => legacy(m.troff));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "TTCN",
		...
		load() {
			return import("./ttcn-12b4tAIc.js").then((m) => legacy(m.ttcn));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "TTCN_CFG",
		extensions: ["cfg"],
		load() {
			return import("./ttcn-cfg-Dkk92D92.js").then((m) => legacy(m.ttcnCfg));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Turtle",
		extensions: ["ttl"],
		load() {
			return import("./turtle-Bg-HE-aG.js").then((m) => legacy(m.turtle));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Web IDL",
		extensions: ["webidl"],
		load() {
			return import("./webidl-CHe8-upe.js").then((m) => legacy(m.webIDL));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "VB.NET",
		extensions: ["vb"],
		load() {
			return import("./vb-B9IXmsBX.js").then((m) => legacy(m.vb));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "VBScript",
		extensions: ["vbs"],
		load() {
			return import("./vbscript-BhryH_5L.js").then((m) => legacy(m.vbScript));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Velocity",
		extensions: ["vtl"],
		load() {
			return import("./velocity-DPleXteh.js").then((m) => legacy(m.velocity));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Verilog",
	...
	/*@__PURE__*/ LanguageDescription.of({
		...
		extensions: ["vhd", "vhdl"],
		load() {
			return import("./vhdl-bHUwN3S3.js").then((m) => legacy(m.vhdl));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "XQuery",
		...
		load() {
			return import("./xquery-CeLkZUHq.js").then((m) => legacy(m.xQuery));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Yacas",
		extensions: ["ys"],
		load() {
			return import("./yacas-COQeIpg9.js").then((m) => legacy(m.yacas));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Z80",
		extensions: ["z80"],
		load() {
			return import("./z80-F_b1IDZ2.js").then((m) => legacy(m.z80));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "MscGen",
		...
		load() {
			return import("./mscgen-9KnR5gwG.js").then((m) => legacy(m.mscgen));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Xù",
		extensions: ["xu"],
		load() {
			return import("./mscgen-9KnR5gwG.js").then((m) => legacy(m.xu));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "MsGenny",
		extensions: ["msgenny"],
		load() {
			return import("./mscgen-9KnR5gwG.js").then((m) => legacy(m.msgenny));
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Vue",
		extensions: ["vue"],
		load() {
			return import("./dist-DxAB7r33.js").then((m) => m.vue());
		}
	}),
	/*@__PURE__*/ LanguageDescription.of({
		name: "Angular Template",
		load() {
			return import("./dist-C6c4fYKM.js").then((m) => m.angular());
		}
	})
];
//#endregion
...
!!!`, "title")
	...
	setup() {
		...
		return () => createVNode("button", {
			...
			disabled: t?.value,
			onClick: () => {
				L$1("https://github.com/imzbf/md-editor-v3");
			},
			type: "button"
			...
			createVNode("div", { class: `${u}-form-item` }, [createVNode("button", {
				...
				onClick: () => {
					if (v) {
						...
						F.emit(o, I, [u$1(g.toDataURL("image/png"))], e.onOk), m();
					}
				}
	...
	setup() {
		const e = inject("editorId"), t = inject("usedLanguageText"), o = inject("disabled"), n = inject("showToolbarName"), i = `${e}-toolbar-wrapper`, s = ref(!1), c = ref(!1), d = ref(), u$5 = () => {
			F.emit(e, I, Array.from(d.value.files || [])), d.value.value = "";
		}, v = (k, E) => {
...
var Ze = () => {
	...
	return { barRender: (g) => {
		if (k.includes(g)) switch (g) {
			...
			return p ? cloneVNode(p, {
				...
				insert(E) {
					F.emit(e, G$1, "universal", { generate: E });
				}
			}) : "";
	...
	const o = inject("editorId"), n = (s) => {
		s instanceof Promise ? s.then((c) => {
			F.emit(o, G$1, "universal", { generate() {
	...
	return (s) => {
		...
		if (s.clipboardData.files.length > 0) {
			...
			F.emit(o, I, Array.from(g).filter((p) => /image\/.*/.test(p.type))), s.preventDefault();
			return;
		}
	...
	},
	{
		...
		shift: () => (F.emit(e, G$1, "strikeThrough"), !0)
	},
	{
		key: "Ctrl-u",
		mac: "Cmd-u",
		preventDefault: !0,
		run: () => (F.emit(e, G$1, "underline"), !0),
		shift: () => (F.emit(e, G$1, "unorderedList"), !0)
	},
	{
		key: "Ctrl-i",
		mac: "Cmd-i",
		preventDefault: !0,
		run: () => (F.emit(e, G$1, "italic"), !0),
		shift: () => (F.emit(e, G$1, "image"), !0)
	},
	{
		key: "Ctrl-1",
		mac: "Cmd-1",
		run: () => (F.emit(e, G$1, "h1"), !0)
	},
	{
		key: "Ctrl-2",
		mac: "Cmd-2",
		run: () => (F.emit(e, G$1, "h2"), !0)
	},
	{
		key: "Ctrl-3",
		mac: "Cmd-3",
		run: () => (F.emit(e, G$1, "h3"), !0)
	},
	{
		key: "Ctrl-4",
		mac: "Cmd-4",
		run: () => (F.emit(e, G$1, "h4"), !0)
	},
	{
		key: "Ctrl-5",
		mac: "Cmd-5",
		run: () => (F.emit(e, G$1, "h5"), !0)
	},
	{
		key: "Ctrl-6",
		mac: "Cmd-6",
		run: () => (F.emit(e, G$1, "h6"), !0)
	},
	{
		key: "Ctrl-ArrowUp",
		mac: "Cmd-ArrowUp",
		run: () => (F.emit(e, G$1, "sup"), !0)
	},
	{
		key: "Ctrl-ArrowDown",
		mac: "Cmd-ArrowDown",
		run: () => (F.emit(e, G$1, "sub"), !0)
	},
	{
		key: "Ctrl-o",
		mac: "Cmd-o",
		run: () => (F.emit(e, G$1, "orderedList"), !0)
	},
	{
		key: "Ctrl-c",
		mac: "Cmd-c",
		shift: () => (F.emit(e, G$1, "code"), !0),
		any(L, T) {
			return (T.ctrlKey || T.metaKey) && T.altKey && T.code === "KeyC" ? (F.emit(e, G$1, "codeRow"), !0) : !1;
		}
	},
	{
		key: "Ctrl-l",
		mac: "Cmd-l",
		run: () => (F.emit(e, G$1, "link"), !0)
	},
	{
		key: "Ctrl-f",
		mac: "Cmd-f",
		shift: () => t.noPrettier ? !1 : (F.emit(e, G$1, "prettier"), !0)
	},
	{ any: (L, T) => (T.ctrlKey || T.metaKey) && T.altKey && T.shiftKey && T.code === "KeyT" ? (F.emit(e, G$1, "table"), !0) : !1 },
	...searchKeymap
...
var Xe = (e) => e.extension instanceof Function ? e.extension(e.options) : e.extension, Ha = (e) => {
	...
	const e = inject("editorId"), t = ref(!0), o = R$2();
	return {
		onCatalogActive: (c, d) => {
...
}), _a = R$2(), za = { flex: 1 }, qa = /* @__PURE__ */ defineComponent({
	...
	setup(e, t) {
		const { noKatex: o, noMermaid: n, noHighlight: i } = e, s = reactive({ scrollAuto: e.scrollAuto }), c = ref(), d = ref(), u$16 = computed(() => g$2({
			...
			props: e,
			ctx: t
		}, "defFooters")), m = et(e), [f, g] = Qt(e, t, { editorId: m }), p = en(e, { editorId: m });
		Zt(e, t, { editorId: m }), Xt(e), Yt(e, t, { editorId: m }), tn(e, t, {
			editorId: m,
			catalogVisible: p,
			setting: f,
			updateSetting: g,
